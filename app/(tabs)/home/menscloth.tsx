    ...
    <SafeAreaView style={styles.safeArea}>
            <View className='flex flex-row justify-between items-center mx-5'>
             <View className='flex flex-row items-center'>
              <Ionicons name="arrow-back" size={24} color="black" 
               ...
               <Text className='text-xl font-bold my-5 mx-2'>Men's clothing</Text>
            </View>
            <Dropdown
        ...
        />
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => <Product handlePress={async () => router.push({ pathname: '/(tabs)/home/productpage', params: { product: JSON.stringify(item) } })} product={item} isLastItem={index === data.length - 1 && data.length % 2 !== 0}/>}
            numColumns={2}
